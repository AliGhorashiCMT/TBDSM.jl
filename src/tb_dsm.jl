...
function __init__()
    ...
    copy!(pb_repo, pyimport_conda("pybinding.repository", "pybinding"))
    copy!(pb_graphene, pyimport_conda("pybinding.repository.graphene", "pybinding"))
    copy!(pb_mos2, pyimport_conda("pybinding.repository.group6_tmd", "pybinding").monolayer_3band("MoS2"))
